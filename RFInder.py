...
__copyright__ = "INAF-OAC"
__email__ = "filippo.maccagni@inaf.it"
...
class RFInder:
    ...
    def __init__(self, file=None, **kwargs):
        ...
        if file != None:
            ...
            config.readfp(open(os.path.realpath(__file__).rstrip('aperfi_class.py') + 'default.cfga'))
        ...
        self.msfile = self.msdir+self.msname[0]
        print self.aperfi_badant
    ...
    def show(self, showall=False):
        ...
        #config.readfp(open(os.path.realpath(__file__).rstrip('RFInder.py') + 'RFIdefault.cfga'))
